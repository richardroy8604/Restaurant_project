...
<style>
  ...
  <div class="registerdata-table">
    ...
    <!-- Booking Data -->
    <span class="booking-data">Booking Data</span>
  </b>
    ...
    <?php
      ...
      if ($result_booking->num_rows > 0) {
        echo '<table border="1">';
        echo '<tr><th>Email</th><th>Phone Number</th><th>Table Number</th><th>Booking Date</th></tr>';
...
<div class="input-container">
    <form action="insert_menu.php" method="post">
      <input type="text" name="item_number" placeholder="Item Number" class="input-box">
      <br>
      <input type="text" name="item" placeholder="Item" class="input-box">
      <br>
      <input type="text" name="price" placeholder="Price" class="input-box">
      <br>
